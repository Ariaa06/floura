  ...
  <main>
    <div class="container-fluid px-4">
      ...
      <div class="container mt-3">
        <form action="<?= base_url('home/aksi_t_karyawan') ?>" method="POST" enctype="multipart/form-data">
          <div class="mb-3 mt-3">
          ...
          <div class="mb-3">
            ...
            <div class="col-sm-10">
              <input type="int" required class="form-control" name="nomor">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="col-sm-10">
             <select  type="select" class="form-control" name="jk" id="jk" name="jk">
               <option value="volvo">Select</option>
               <option value="1">cowo</option>
               <option value="2">cewe</option>s
             </select>
            </div>
          </div>
